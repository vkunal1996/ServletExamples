...
import java.io.*;
public class RecieveUserinformation extends HttpServlet
{
        ...
        pw.print("<p align='center'>");
			...
			"<h1 id='heading'>User Information</h1>"+
                    "<table border='0' cellspacing='12'>"+
                        ...
                        "<tr>"+
                            "<td>Username :</td>"+
                            "<td><input type=text name='username' size=25 value='"+user+"' disabled></td>"+
                        "</tr>"+
                        "<tr>"+
                            "<td>Password :</td>"+
                            "<td><input type=text name='password' size=25 value='"+pass+"' disabled></td>"+
                        "</tr>"+
                        
                        "<tr>"+
                            "<td>MotherName :</td>"+
                            "<td><input type=text name='mname' size=25 value='"+mn+"' disabled></td>"+
                        "</tr>"+
                        "<tr>"+
                            "<td>FatherName :</td>"+
                            "<td><input type=text name='fname' size=25 value='"+fn+"' disabled></td>"+
                        "</tr>"+
                        "<tr>"+
                                "<td colspan='2'>"+
                                    "<fieldset>"+
                                        "<legend>Sex</legend>"+
                                        "<input type='text' name='Sex' value='"+S+"' disabled>"+
                                    "</fieldset>"+
                                "</td>"+
                        "</tr>"+
