					...
					pw.print("<table>");
							...
							try
							{
								if(prev.equals("oldhindi1"))
								{
									...
									int a=1;
									sql="SELECT * FROM VideoPath WHERE ID=?";
										...
										while(rs.next())
										{
											pw.print("<tr>");
												...
												pw.print("<td>");
													...
													pw.print("<video width='320' height='240' controls>");				
													pw.print("<source src='"+rs.getString("Path")+"' type=video/mp4>");
													pw.print("</video>");													
												pw.print("</td>");
											pw.print("</tr>");
										}
										...
										while(rs.next())
										{
											pw.print("<tr>");
												...
												pw.print("<td>");
													...
													String urlSong=rs.getString("Path");
pw.print("<video width='320' height='240' controls>");													pw.print("<source src='"+rs.getString("Path")+"' type=video/mp4>");
													pw.print("</video>");													
												pw.print("</td>");
											pw.print("</tr>");
										}
										...
										while(rs.next())
										{
											pw.print("<tr>");
												...
												pw.print("<td>");
													...
													String urlSong=rs.getString("Path");
												pw.print("<video height='320' width='240' controls>");
												pw.print("<source src='"+rs.getString("Path")+"' type=video/mp4>");
												pw.print("</video>");													
												pw.print("</td>");
											pw.print("</tr>");
